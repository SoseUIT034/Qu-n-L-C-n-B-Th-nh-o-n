...
CREATE TABLE `user` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_canbo` FOREIGN KEY (`id`) REFERENCES `canbo` (`MaCanBo`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user` VALUES (0,'Admin','202cb962ac59075b964b07152d234b70','ACTIVE'),(1,'Employee','202cb962ac59075b964b07152d234b70','ACTIVE'),(2,'User','202cb962ac59075b964b07152d234b70','ACTIVE');
...
CREATE TABLE `usersandroles` (
  ...
  KEY `FK_mw3paewh84po0jfljac72i7h3` (`role_id`),
  CONSTRAINT `FK_cb26g3tm6ki5oidvfk9usvww5` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FK_mw3paewh84po0jfljac72i7h3` FOREIGN KEY (`role_id`) REFERENCES `role` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-06-11 12:44:09
