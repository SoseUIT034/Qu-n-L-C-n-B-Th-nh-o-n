...
@Service
public class TrinhDoChuyenMonServiceImp extends HibernateUtils implements TrinhDoChuyenMonService {
	@Autowired
	TrinhDoChuyenMonDAO  trinhDoChuyenMonDAO;
	...
	public List<Trinhdochuyenmon> listTrinhDoChuyenMon() {
		 return trinhDoChuyenMonDAO.listTrinhDoChuyenMon();
	}
