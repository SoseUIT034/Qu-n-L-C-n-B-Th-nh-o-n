...
public class TonGiaoController {
	...
	@RequestMapping(value = { "/createTonGiao"}, method = RequestMethod.GET)
...
//		}
		...
		model.addAttribute("tongiao", new Tongiao());  
	...
	@RequestMapping(value = { "/listtongiao"}, method = RequestMethod.GET)
...
//		}
		...
		// model
	    ArrayList<Tongiao>  tongiao = new ArrayList<Tongiao>();
		
		tongiao= (ArrayList<Tongiao>) tg.listTonGiao() ; 
		model.addAttribute("listTongiao", tongiao);  
		
		return "/TonGiao/list_tongiao";
	}
	
	
	@RequestMapping(value = { "/edittongiao/{id}"}, method = RequestMethod.GET)
...
//		}
		...
		tongiao= tg.getTonGiaoById(id);
		 
		model.addAttribute("tongiao", tongiao);  
