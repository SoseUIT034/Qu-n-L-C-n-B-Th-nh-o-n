...
<body ">
	...
	<div class="content" style="padding-top: 30px; ">
		...
		<form:form class="container" commandName="trinhdochuyenmon" action="createtrinhdochuyenmon" style="border: rebeccapurple; border-style: dotted;" method="POST" >
			   
			  <div class="row" disabled="true" style="display:none;">
			    <div class="col-xs-12 col-md-4">
			      <label>Mã trình độ chuyên môn</label>
			    </div>
