...
<body ">
	...
	<div class="content container"  style="padding-top:30px; border: rebeccapurple; border-style: dotted; padding:50px">
 		 <a href="createtrinhdochuyenmon">Thêm mới</a>
 		 ...
 		 <table class="table table-hover table-striped">
	 		 ...
	 		 <tbody>
		 		 <c:forEach items="${trinhdochuyenmon}" var="item" varStatus="loop"> 
					<tr>
						<td>${loop.index+1}</td>
			 		 	<td> ${item.maTrinhDoChuyenMon} </td>
			 		 	<td> ${item.tenTrinhDoChuyenMon} </td> 
			 		 	<td><a href="edittrinhdochuyenmon/${item.maTrinhDoChuyenMon}">Sửa</a></td> 
		 		 	</tr>
				 </c:forEach>
	 		  </tbody>
 		 </table>
