...
<body >
	...
	<div class="content" style="padding-top: 30px; ">
		...
		<form:form class="container" commandName="trinhdochuyenmon" action="edittrinhdochuyenmon" style="border: rebeccapurple; border-style: dotted;" method="POST" >
			   
			  <div class="row">
			    <div class="col-xs-12 col-md-4">
			      <label>Mã trình dộ chuyên môn</label>
			    </div>
			    <div class="col-xs-12 col-md-8">
			      <form:input path="maTrinhDoChuyenMon" class="form-control" type="text"  disabled="true" /> 
			    </div> 
			  </div>
			  <div class="row" style="display: none">
			    ...
			    <div class="col-xs-12 col-md-8">
			      <form:input path="maTrinhDoChuyenMon" class="form-control" type="text"    /> 
			    </div> 
			  </div>
			 <div class="row">
			    <div class="col-xs-12 col-md-4">
			    ...
			    <div class="col-xs-12 col-md-8">
			      <form:input path="tenTrinhDoChuyenMon" class="form-control" type="text"/> 
			       <form:errors path="tenTrinhDoChuyenMon" class="btn btn-danger"></form:errors>
			    </div> 
			  </div>
