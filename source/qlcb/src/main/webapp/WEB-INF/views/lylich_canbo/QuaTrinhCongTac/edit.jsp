...
<body>
	<form:form  class="clearfix" commandName="Lichsucongtac" action="${pageContext.request.contextPath}/lichsucongtac/edit"  method="POST" >
		<div  class="col-md-12">
			...
			<div class=" col-xs-12 col-md-12" style="display: none">
				...
				<div class="col-xs-12 col-md-8">
					<form:input path="maLsct"  class="form-control" type="date-time"/>
				</div>
			</div>
