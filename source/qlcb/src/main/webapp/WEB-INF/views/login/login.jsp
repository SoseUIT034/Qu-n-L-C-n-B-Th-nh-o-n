...
<body>
	...
	<div class="main">
		...
		<div class="signin-form">
		 <c:url var="actionUrl"  value="dologin" />
		 
		 
		 
			<form:form id="loginForm" commandName="account"   menthod="POST" action ="${actionUrl }">
				<ul>
					<li>
  						<form:input path="username" type="text" placeholder="User Name" required=""/>  
